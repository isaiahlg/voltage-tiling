...
saveRDS(buses.h3, "10x/variables/buses_h3_r8.rds")
```

## Visualize Hexes
```{r}
# import buses.h3 and lines
buses.h3 <- readRDS("10x/variables/buses_h3_r8.rds")
lines.sf <- readRDS("10x/variables/lines_sf.rds")
...
```{r}
# import buses.h3 and lines
buses.h3 <- readRDS("10x/variables/buses_h3.rds")
map <- readRDS("10x/variables/map_stadia_z17.rds")
...
saveRDS(buses.h3.filt, "10x/variables/buses_h3_filt.rds")
saveRDS(buses.h3.filt.true, "10x/variables/buses_h3_filt_true.rds")
```

## Plot Multi-Res Hexes
```{r}
# import buses.h3 and lines
buses.h3.filt <- readRDS("10x/variables/buses_h3_filt.rds")
lines.sf <- readRDS("10x/variables/lines_sf.rds")
