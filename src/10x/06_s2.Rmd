...
glimpse(buses.s2)
# export
saveRDS(buses.s2, "data/10x/buses_s2_r14to15.rds")
```

## Visualize Tiles
```{r}
# import buses.s2 and lines
buses.s2 <- readRDS("data/10x/buses_s2_r14to18.rds")
...
# read in data
buses.sf <- readRDS("data/10x/buses_sf.rds")
buses.s2 <- readRDS("data/10x/buses_s2.rds")
...
saveRDS(buses.s2.filt, "data/10x/buses_s2_filt.rds")
saveRDS(buses.s2.filt.true, "data/10x/buses_s2_filt_true.rds")
```

## Plot Multi-Res Hexes
```{r}
# import buses.s2 and lines
buses.s2.filt <- readRDS("data/10x/buses_s2_filt.rds")
lines.sf <- readRDS("data/10x/lines_sf.rds")
...
# buses.sf <- readRDS("data/10x/buses_sf_s2.rds")
