...
saveRDS(p13u_sf, "data/10x/p13u_sf.rds")
```
Rows: 882,412
Columns: 24
...
# read in RDS
p13u <- readRDS("data/10x/p13u_sf.rds")

# look at the names of the type "Load"
p13u %>%
    filter(type == "Storage") %>%
    select(name) %>%
    head()
...
saveRDS(lines.sf, "data/10x/lines_sf.rds")
saveRDS(buses.sf, "data/10x/buses_sf.rds")
```
