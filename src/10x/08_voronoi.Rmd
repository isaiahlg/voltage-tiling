...
```{r}
# read in buses.sv
buses.sv <- readRDS("data/10x/buses_vec.rds")
...
# export
saveRDS(voronoi.sv, "data/10x/voronoi_sv.rds")
...
```{r}
# read in voronoi.sv
boundary.sv <- readRDS("data/10x/buses_concave_c2_sv.rds")
voronoi.sv <- readRDS("data/10x/voronoi_sv.rds")
...
# reexport voronoi.sf
saveRDS(voronoi.sf, "data/10x/voronoi_sf.rds")
...
```{r}
# read in voronoi.sf
voronoi.sf <- readRDS("data/10x/voronoi_sf.rds")
...
ggsave(
  filename = "10x/figures/voronoi_plot_mask_w_lines.png", 
  voronoi_plot,
  width = 6480,
  height = 6480,
  dpi = 300,
