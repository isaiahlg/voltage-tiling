...
buses.sf <- readRDS("data/10x/buses_sf.rds")
buses.buffer.sv <- readRDS("data/10x/buses_buffer_1000m_vec.rds")
...
saveRDS(contour, "data/10x/contour_n10_rast.rds")
######################
...
```{r}  
# read in data
contour <- readRDS("data/10x/contour_n100_rast.rds")
boundary.sv <- readRDS("data/10x/buses_concave_c1_sv.rds")
...
# export df 
saveRDS(contour.df, "data/10x/contour_mask_n10_df.rds")
# glimpse(contour.df)
...
# import map
map <- readRDS("data/10x/map_stadia_z14.rds")
contour.df <- readRDS("data/10x/contour_mask_n10_df.rds")
