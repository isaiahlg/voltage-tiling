...
saveRDS(grd, "./exports/grd400K.rds")
...
saveRDS(buses.idw, "./exports/buses_idw_k1_n1_400k.rds")
```

## Convert Gridded Heatmap to Shapefile
```{r}
# read back in
buses.idw <- readRDS("./exports/buses_idw_k1_n1.rds")
# plot(buses.idw)
...
# save buses.idw.sf
saveRDS(buses.idw.sf, "./exports/buses_idw_sf_k1_n1.rds")
```

## Export to JSON File for Web App
```{r}
library(jsonlite)
library(sf)
