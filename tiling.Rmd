...
buses.sf <- buses.sf %>% mutate(
  weighted_voltage_n10_d2 = purrr::map_dbl(
    row_number(),
...
saveRDS(grd, "./exports/grd.rds")
saveRDS(buses.sp, "./exports/buses_sp.rds")
```
...
library(gstat) # for idw
# import grd, buses.sp
grd <- readRDS("./exports/grd.rds")
buses.sp <- readRDS("./exports/buses_sp.rds")
...
saveRDS(buses.idw, "./exports/buses_idw_k10_n1.rds")
```

## Convert Gridded Heatmap to Shapefile
```{r}
# read back in
buses.idw <- readRDS("./exports/buses_idw_k1_n10.rds")
# plot(buses.idw)
...
# save buses.idw.sf
saveRDS(buses.idw.sf, "./exports/buses_idw_sf_k1_n10.rds")
```

## Plot the Heatmap
```{r}
buses.idw.sf <- readRDS("./exports/buses_idw_sf_kall_n1.rds")
lines.sf <- readRDS("./exports/lines_sf.rds")
...
saveRDS(buses.h3, "./exports/buses_h3.rds")
```
...
# export
saveRDS(voronoi.sf, "./exports/voronoi_sf.rds")
saveRDS(voronoi.sp, "./exports/voronoi_sp.rds")
```
...
# export buses.s2
saveRDS(buses.s2, "./exports/buses_s2.rds")
```
